    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
        ...
        <motion.h1 
          ...
          className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-bold font-display tracking-tight mb-8"
        >
          Crafting digital
          <br />
        ...
        <motion.div 
          ...
          className="mt-20 flex items-center justify-center gap-6 text-muted-foreground"
        >
          <a href="#" className="hover:text-foreground transition-colors p-2 hover:bg-foreground/5 rounded-full"><Github className="w-5 h-5" /></a>
          <a href="#" className="hover:text-foreground transition-colors p-2 hover:bg-foreground/5 rounded-full"><Twitter className="w-5 h-5" /></a>
          <a href="#" className="hover:text-foreground transition-colors p-2 hover:bg-foreground/5 rounded-full"><Linkedin className="w-5 h-5" /></a>
        </motion.div>
      </div>
    </section>
  );
